Using database: BasinExplorerBE at localhost
...
class BasinmanagerJunctionpoints(models.Model):
    id = models.BigAutoField(primary_key=True)

    class Meta:
        managed = False
        db_table = 'BasinManager_junctionpoints'
...
class JunctionPoints3857(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'junction_points_3857'


class RiverStreams3857(models.Model):
    gid = models.AutoField(primary_key=True)
    arcid = models.FloatField(blank=True, null=True)
    grid_code = models.FloatField(blank=True, null=True)
    from_node = models.FloatField(blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'river_streams_3857'


class WatershedPoly3857(models.Model):
    gid = models.AutoField(primary_key=True)
